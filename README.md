...
### Персональный словарь
#Screenshot: [dictionary](images/dictionary.png)
...
#Screenshot: [video](images/video) [player](images/player.png)
...
### Тренировка
#Screenshot: [train](images/train.png)
...
### Профиль пользователя
#Screenshot: [profile](images/profile)
